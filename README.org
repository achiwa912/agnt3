...
- Weak model can be too weak
  - Initially, I wanted to use "cheap" =gemini-2.5-flash-lite= model, but it continued to hallucinate to the point updating system_prompt can't set proper guardrails.  I needed a smarter model (eg, 3.5-flash-lite) for this project.
